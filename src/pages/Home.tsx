        ...
        <div className="flex flex-col md:flex-row gap-8 items-start">
          <div className="flex-1">
            ...
            <div className="flex flex-wrap gap-6">
              <button className="inline-flex items-center gap-3 px-8 py-4 bg-zinc-100 text-zinc-900 rounded-full text-lg font-medium hover:bg-white transition-colors">
                <Download className="w-5 h-5" />
                Télécharger mon CV
              </button>
              <button className="inline-flex items-center gap-3 px-8 py-4 bg-zinc-900 border border-zinc-700 text-zinc-300 rounded-full text-lg font-medium hover:bg-zinc-800 hover:text-white transition-colors">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
        <div className="bg-zinc-900/30 border border-zinc-800 rounded-3xl p-10 hover:bg-zinc-900/50 transition-colors">
          ...
          <p className="text-xl text-zinc-400 mb-8 leading-relaxed">
            Formation Initiale (2025) au <strong>Lycée Lamartine (Mâcon)</strong>. Poursuite du cursus BTS SIO SISR avec consolidation des acquis théoriques.
          </p>
          <div className="flex gap-3">
            <span className="px-4 py-2 bg-zinc-950 border border-zinc-800 rounded-full text-base text-zinc-300 font-mono">SISR</span>
            <span className="px-4 py-2 bg-zinc-950 border border-zinc-800 rounded-full text-base text-zinc-300 font-mono">Cyber</span>
            <span className="px-4 py-2 bg-zinc-950 border border-zinc-800 rounded-full text-base text-zinc-300 font-mono">Réseaux</span>
          </div>
        </div>
        ...
        <div className="bg-zinc-900/30 border border-zinc-800 rounded-3xl p-10 hover:bg-zinc-900/50 transition-colors">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-zinc-500 text-base">Alternance Année 1 • Lutte contre les cybermenaces (Bourg-en-Bresse, Ain)</p>
            </div>
            <div>
              <h3 className="text-white font-medium text-xl mb-1">Hisis Informatique</h3>
              <p className="text-zinc-500 text-base">Stage Année 2 • ESN Expert Santé</p>
            </div>
          </div>
        </div>
      </div>
